...
final class Version20220825143046 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE image ADD CONSTRAINT FK_C53D045FB37D7BCC FOREIGN KEY (main_image_trick_id) REFERENCES trick (id) ON DELETE CASCADE');
        ...
        $this->addSql('ALTER TABLE trick ADD CONSTRAINT FK_D8F0A91E9B875DF8 FOREIGN KEY (trick_group_id) REFERENCES `group` (id) ON DELETE CASCADE');
